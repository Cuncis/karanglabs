...
export default function ChangelogGenerator({ history = [] }) {
    ...
    const handleFillRandom = () => {
        const audiences = ['technical', 'users', 'mixed'];
            ...
            <main className="container mx-auto px-4 py-12 md:py-20 max-w-5xl">
                ...
                <div className="mb-12">
                    <div className="flex items-center justify-between mb-8 border-b border-gray-800 pb-4">
                        <Link href="/ai-tools" className="inline-flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm font-medium bg-gray-900 hover:bg-gray-800 px-4 py-2 rounded-lg border border-gray-800 w-fit">
                            ...
                            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6 mt-6">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <button 
                                        ...
                                        className="text-xs text-[#F59E0B] hover:text-[#F59E0B]/70 transition-colors py-1 px-2 rounded hover:bg-[#F59E0B]/10"
                                    >
                                        Clear
                                    </button>
                                </div>
                                <div className="space-y-3 max-h-72 overflow-y-auto pr-2 custom-scrollbar">
                                    {history.map(item => (
                                        <button 
                                            ...
                                            className="w-full text-left p-4 rounded-lg bg-gray-950 border border-gray-800 hover:border-[#F59E0B]/50 hover:bg-gray-900 transition-all flex justify-between items-center group"
                                        >
                                            <div className="truncate pr-4 flex-1">
                                                <p className="text-sm font-medium text-gray-200 truncate">{item.original_prompt}</p>
                                                <p className="text-xs text-gray-500 mt-1">
                                                    <span className="uppercase text-xs mr-2">{item.audience}</span>
                                                    {formatDate(item.timestamp)}
                                                </p>
                                            </div>
                                            <div className="text-[#F59E0B] opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:translate-x-1 duration-300">
