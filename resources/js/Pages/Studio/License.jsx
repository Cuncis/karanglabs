...
export default function License() {
    const { licenseKey, hasDownload } = usePage().props;
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <div className="mt-2 inline-flex items-center gap-1.5 text-xs text-[#8A8A93] dark:text-[#666]">
                            <ShieldCheck className="h-3.5 w-3.5" /> Link download bersifat pribadi, terikat license key kamu &amp; kedaluwarsa otomatis.
                        </div>
                    </div>
                    {hasDownload ? (
                        <a
