...
export default function Addons() {
    ...
    return (
        <AppLayout active="addons">
            <div className="mb-10 flex items-start justify-between gap-4">
                <div>
                    <span className="text-xs font-medium uppercase tracking-[0.2em] text-brand-600 dark:text-brand-400">Add-ons</span>
                ...
                {ADDONS.map((a) => (
                    <div key={a.title} className="rounded-xl border border-[#E4E4E7] dark:border-[#222] bg-white dark:bg-[#111] p-6">
                        <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-brand-400/10">
                            <a.icon className="h-5 w-5 text-brand-600 dark:text-brand-400" />
                        </div>
